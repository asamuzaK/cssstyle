...
module.exports.definition = {
  set(v) {
    ...
    if (parsers.hasVarFunc(v)) {
      ...
      this._implicitPositionSetter("border-right", "", "right", positions);
      ...
      if (obj === "") {
        ...
        this._implicitPositionSetter("border-right", propertyValue, "right", positions);
        this._setProperty("border-right", propertyValue);
        this._setProperty("border", "");
      }
    }
  },
