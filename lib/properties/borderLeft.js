...
module.exports.definition = {
  set(v) {
    ...
    if (parsers.hasVarFunc(v)) {
      ...
      this._implicitPositionSetter("border-left", "", "left", positions);
      ...
      if (obj === "") {
        ...
        this._implicitPositionSetter("border-left", propertyValue, "left", positions);
        this._setProperty("border-left", propertyValue);
        this._setProperty("border", "");
      }
    }
  },
  get() {
    ...
    const subVal = this._shorthandGetter("border-left", module.exports.shorthandFor, initialValues);
