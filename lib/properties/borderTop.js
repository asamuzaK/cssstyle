...
module.exports.definition = {
  set(v) {
    ...
    if (parsers.hasVarFunc(v)) {
      ...
      this._implicitPositionSetter("border-top", "", "top", positions);
      ...
      if (obj === "") {
        ...
        this._implicitPositionSetter("border-top", propertyValue, "top", positions);
        this._setProperty("border-top", propertyValue);
        this._setProperty("border", "");
      }
    }
  },
  get() {
    ...
    const subVal = this._shorthandGetter("border-top", module.exports.shorthandFor, initialValues);
